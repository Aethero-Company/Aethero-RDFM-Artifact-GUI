...
class AetheroTheme:
    ...
    def apply_theme(cls, root: tk.Tk) -> ttk.Style:
        ...
        style.map('TButton',
                 background=[('active', cls.MID_GRAY),
        ...
        style.map('Add.TButton',
                 background=[('active', '#122d5a'),
                           ('pressed', cls.BTN_ADD_BORDER)])
        ...
        style.map('Delete.TButton',
                 background=[('active', '#5a1018'),
                           ('pressed', cls.BTN_DELETE_BORDER)])
        ...
        style.map('TNotebook.Tab',
                 background=[('selected', cls.TAB_BG),
                           ('active', cls.TAB_BG)],
                 foreground=[('selected', cls.PRIMARY_TEXT),
                           ('active', cls.PRIMARY_TEXT)],
                 lightcolor=[('selected', cls.TAB_BG),
                           ('!selected', cls.TAB_BG)],
                 darkcolor=[('selected', cls.TAB_BG),
                           ('!selected', cls.TAB_BG)],
                 bordercolor=[('selected', cls.TAB_BG),
                            ('!selected', cls.TAB_BG)])
        ...
        style.map('TCheckbutton',
                 background=[('active', cls.FRAME_BG)])
